<template>
  ...
  <div class="card-header d-flex justify-content-between">
    ...
    <div class="card-title">
      <!-- Display comment publication date -->
  ...
  <div v-if="!toggleEdit" class="card-body">
    <!-- Display comment content if not in edit mode -->
    <p class="card-text">{{ comment.content }}</p>
  </div>
  <div class="card-body" v-if="toggleEdit">
    <!-- EditComment component for editing the comment -->
    <EditComment :comment="comment" @edited="handleCommentAdded" />
  </div>

  <!-- Edit Comment Toggle (visible only to comment owner) -->
